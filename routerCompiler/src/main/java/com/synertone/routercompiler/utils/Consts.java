package com.synertone.routercompiler.utils;
...
public class Consts {
    ...
    public static final ClassName ROUTER = ClassName.get("com.synertone.routercore", "DNRouter");

    public static final String ARGUMENTS_NAME = "moduleName";
    public static final String ANN_TYPE_ROUTE = "com.synertone.routerannotation.Route";
    public static final String ANN_TYPE_Extra = "com.synertone.routerannotation.Extra";


    public static final String IROUTE_GROUP = "com.synertone.routercore.template.IRouteGroup";
    public static final String IROUTE_ROOT = "com.synertone.routercore.template.IRouteRoot";
    public static final String IEXTRA = "com.synertone.routercore.template.IExtra";

    public static final String METHOD_LOAD_INTO = "loadInto";
    public static final String METHOD_LOAD_EXTRA = "loadExtra";

    public static final String ACTIVITY = "android.app.Activity";
    public static final String ISERVICE = "com.synertone.routercore.template.IService";
    ...
    public static final String PACKAGE_OF_GENERATE_FILE = "com.synertone.myrouter.routes";
